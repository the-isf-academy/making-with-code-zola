...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/making-with-code/flexsearch.min.js');loadScript('/making-with-code/en.search-data.min.f4822c2cff38e2d7d2e10130b2aacd7e935ff552dc7114e0bba7370436f4857c.js',function(){input.required=false;search();});}
