...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/making-with-code/flexsearch.min.js');loadScript('/making-with-code/en.search-data.min.6904924d135003ebb7aab64cb77fa600cb82359ce6b5b66876154b2cdc2f1060.js',function(){input.required=false;search();});}
