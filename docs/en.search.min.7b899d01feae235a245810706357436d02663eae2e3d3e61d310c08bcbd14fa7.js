...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/making-with-code/flexsearch.min.js');loadScript('/making-with-code/en.search-data.min.22dabc30d35317dcf3d1248539494a541e547eaf535aa3b2e010d1b09da9cc53.js',function(){input.required=false;search();});}
