...
{{< code-action "Open up:" >}} `conditionals-example.py` **in Atom.**
```shell
atom conditionals-example.py
```
{{< code-action "Change the code to create the following cases for the variable:" >}} `i`
- if `i` is less than 5
    - print: "I'm still tiny"
- elif `i` is equal to `10`
    - print: "Half way there"
- elif `i` is less than `18`
    - print: "I'm an adult!"
- else
    - print: "Ugh"
...
{{< code-action "Open the file" >}} `conditionals-user-input`. 
